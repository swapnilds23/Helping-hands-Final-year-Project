...
import { GET_ALL_CLOTHCENTER } from '.././queries';
import './App.css';
...
class Clothes extends React.Component {
    ...
    displaySider(){
      ...
      return (
        <Menu theme="dark"  mode="inline" >
           {
                this.props.data.getAllClothCenter.map(clothes => {
                    return (
                        clothes.coordinates.map(coordnt => {
                          return(
                              <Menu.Item key={clothes.id} lat ={coordnt.lat} lng= {coordnt.log} onClick={this.handleDestination}>
       ...
       return(
        ...
        <Layout>
                ...
                >
                  ...
                  { homeLat && homeLng && this.props.data.getAllClothCenter ? (
                    <MapWithAMarker
                        ...
                        lat={homeLat}
                        lng={homeLng}
                        locationCo={this.props.data.getAllClothCenter}
                      />
                    ):
  ...
  export default graphql(GET_ALL_CLOTHCENTER)(Clothes);
