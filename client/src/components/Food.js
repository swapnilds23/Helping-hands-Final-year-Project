...
import { GET_ALL_FOODCENTER } from '.././queries';
import './App.css';
...
class Food extends React.Component {
    ...
    displaySider(){
      ...
      return (
        <Menu theme="dark"  mode="inline" >
           {
                this.props.data.getAllFoodCenter.map(food => {
                    return (
       ...
       return(
        ...
        <Layout>
                ...
                >
                  ...
                  { homeLat && homeLng && this.props.data.getAllFoodCenter ? (
                    <MapWithAMarker
                        ...
                        lat={homeLat}
                        lng={homeLng}
                        locationCo={this.props.data.getAllFoodCenter}
                      />
                    ):
  ...
  export default graphql(GET_ALL_FOODCENTER)(Food);
